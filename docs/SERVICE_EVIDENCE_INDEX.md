...
| [`SERVICE_EVIDENCE_INDEX.md`](SERVICE_EVIDENCE_INDEX.md) | This service evidence map. |
| [`agent-docs.md`](agent-docs.md) | Agent docs entrypoint. |
...
| [`index-freshness.md`](index-freshness.md) | Report index freshness reference. |
...
1. ../README.md
2. README.md
3. pool-stack-architecture.md
4. ROADMAP.md
5. SERVICE_CORE_SEQUENCE.md
6. SERVICE_CAPABILITY_SCORECARD.md
7. SERVICE_SCORE_GAP.md
8. LOCAL_GATE_REFERENCE.md
9. release-artifact-contract.md
10. operator-runbook.md
```
